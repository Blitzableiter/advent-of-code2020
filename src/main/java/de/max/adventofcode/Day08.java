...
public class Day08
{
  ...
  private static void part1()
  {
    ...
    List<String> bootCodeStatements = Utils.getListFromFilename("input-day08.txt");
    // (%s) (+|-)(%d)
  ...
  private static void part2()
  {
    ...
    List<String> bootCodeStatementsForCounter = Utils.getListFromFilename("input-day08.txt");
    // (%s) (+|-)(%d)
    Pattern pattern = Pattern.compile("(\\w+)\\s([+-])(\\d+)");
    Integer i = 0;
    Integer acc = 0;
